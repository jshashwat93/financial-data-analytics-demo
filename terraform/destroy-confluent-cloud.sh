...
echo -e "\n\n\033[1;34mIf you are done with using Terraform for this demo, you should delete the \033[1;31m.env\033[1;34m file for security reasons. You can run \033[1;32mrm -f terraform/.env\033[1;34m to delete this file.\033[0m"
