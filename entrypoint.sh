...
echo "Starting Coinbase and Coingecko Producers. Keep an eye on the 'coinbase-btc' and 'coingecko-btc' topics in your Confluent Cloud cluster to see real-time financial data analytics in action! Get ready to explore use cases such as crypto arbitrage and volatility analysis in a hands-on environment!"
